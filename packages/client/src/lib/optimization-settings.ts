...
/**
 * Built-in Meta-Prompt templates for different use cases.
 * Each template emphasizes:
 *  1. Output format requirements (JSON)
 *  2. originalText must be an exact substring
 *  3. Domain-specific evaluation dimensions
 */
...
export const BUILTIN_META_PROMPTS: MetaPromptTemplate[] = [
  {
    id: 'general',
    labelKey: 'templateGeneral',
    prompt: `You are a professional Prompt Engineer, skilled at analyzing and optimizing AI Prompts.
...
Return the result in this JSON format:
{
  ...
  {
    id: 'codeAssistant',
    labelKey: 'templateCodeAssistant',
    prompt: `You are a Prompt Engineer specializing in code assistant prompts.
...
Return the result in this JSON format:
{
  ...
  {
    id: 'contentWriter',
    labelKey: 'templateContentWriter',
    prompt: `You are a Prompt Engineer specializing in content creation prompts.
...
Return the result in this JSON format:
{
  ...
  {
    id: 'translator',
    labelKey: 'templateTranslator',
    prompt: `You are a Prompt Engineer specializing in translation prompts.
...
Return the result in this JSON format:
{
  ...
  {
    id: 'dataAnalyzer',
    labelKey: 'templateDataAnalyzer',
    prompt: `You are a Prompt Engineer specializing in data analysis prompts.
