...
test('downloadBuffer rejects when metadata size exceeds limit', async () => {
    ...
    await assert.rejects(() => service.downloadBuffer('user-1', 'file-1', { maxBytes: 5 }), /exceeds size limit/);
});
...
//# sourceMappingURL=files.service.test.js.map