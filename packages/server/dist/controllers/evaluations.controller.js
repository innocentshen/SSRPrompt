...
import { evaluationsService, testCasesService, criteriaService, runsService, } from '../services/evaluations.service.js';
import { toNodeReadable } from '../utils/stream.js';
import { CreateEvaluationSchema, UpdateEvaluationSchema, CreateTestCaseSchema, UpdateTestCaseSchema, CreateCriterionSchema, UpdateCriterionSchema, } from '@ssrprompt/shared';
import { z } from 'zod';
...
export const evaluationsController = {
    ...
    async downloadFile(req, res) {
        ...
        const { meta, body, contentLength, contentRange } = await evaluationsService.downloadAttachment(userId, evaluationId, fileId, range);
     ...
     */
    async batchUpdateOrder(req, res) {
        const updates = z
...
export const testCasesController = {
    ...
    async create(req, res) {
        ...
        const testCase = await testCasesService.create(req.user.userId, req.params.evaluationId, data);
...
export const criteriaController = {
    ...
    async create(req, res) {
        ...
        const criterion = await criteriaService.create(req.user.userId, req.params.evaluationId, data);
